    ...
    <div className="py-24 h-screen w-screen bg-[#CAC2AF]">
      <div className=" ">
        <div className="text-3xl text-center py-2 px-3">
            Do you enjoy participating in team meetings and sharing ideas with fellow engineers? OR
        </div>
        ...
        <div className="py-5 px-24">
            <button onClick={() => navigate('/Hat')} className="bg-[#2A4223] hover:bg-[#305127] text-white font-bold w-full py-2 px-4 rounded ">Next</button>
        </div>
      </div>
    </div>
  );
