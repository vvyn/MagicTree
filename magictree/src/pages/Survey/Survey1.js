    ...
    <div className="py-32 h-screen w-screen bg-[#CAC2AF]">
      <div className=" ">
        <div className="text-3xl text-center py-2 px-3">
          Do you prefer collaborating with a team of engineers? OR
        </div>
        ...
        <div className="text-3xl text-center py-2 px-3">
          Do you prefer working independently on technical challenges?
        </div>

       
        <div className="py-5 px-24">
            <button onClick={() => navigate('/Survey2')} className="bg-[#2A4223] hover:bg-[#305127] text-white font-bold w-full py-2 px-4 rounded ">Next</button>
        </div>
      </div>
    </div>
  );
